# Email Marketing Sequence — Small Business Finance Dashboard
# 5 emails over 7 days. Import into Mailchimp / ConvertKit / Beehiiv.

---

## EMAIL 1 — Day 0 (Welcome)
**Subject:** You asked about Budget Tracker — here's where to start

Hi [First Name],

Thanks for joining. I want to give you something useful right away.

The #1 mistake people make with Budget Tracker:
...
Next email comes in 2 days — I'll share the 80/20 of Budget Tracker.
...
## EMAIL 2 — Day 2 (Value)
**Subject:** The 80/20 of Budget Tracker (most people ignore this)

Hi [First Name],

Quick one today.

20% of Budget Tracker techniques produce 80% of results.
...
When I started with Budget Tracker, I spent 6 months consuming content without making real progress.

Why? I was optimizing for learning instead of doing.

The shift that changed everything: I stopped reading about Budget Tracker and started *applying* one thing at a time.

Results came within 2 weeks.

I documented the exact system I built into **Small Business Finance Dashboard** — a spreadsheet pack that covers:
→ The core framework
→ Ready-to-use templates
→ Step-by-step from zero

It's $19 one-time: https://zenithal43.gumroad.com/l/aidlxr
...
The most common thing I hear: "I'd love to get better at Budget Tracker but I don't have time."
...
If you've been putting it off, Small Business Finance Dashboard gives you the exact 20% to focus on.

$19: https://zenithal43.gumroad.com/l/aidlxr
...
This is the last email I'll send about Small Business Finance Dashboard.
