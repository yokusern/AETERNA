# Email Marketing Sequence — ChatGPT Business Prompt Mega Pack
# 5 emails over 7 days. Import into Mailchimp / ConvertKit / Beehiiv.

---

## EMAIL 1 — Day 0 (Welcome)
**Subject:** You asked about ChatGPT Prompts — here's where to start

Hi [First Name],

Thanks for joining. I want to give you something useful right away.

The #1 mistake people make with ChatGPT Prompts:
...
Next email comes in 2 days — I'll share the 80/20 of ChatGPT Prompts.
...
## EMAIL 2 — Day 2 (Value)
**Subject:** The 80/20 of ChatGPT Prompts (most people ignore this)

Hi [First Name],

Quick one today.

20% of ChatGPT Prompts techniques produce 80% of results.
...
When I started with ChatGPT Prompts, I spent 6 months consuming content without making real progress.

Why? I was optimizing for learning instead of doing.

The shift that changed everything: I stopped reading about ChatGPT Prompts and started *applying* one thing at a time.

Results came within 2 weeks.

I documented the exact system I built into **ChatGPT Business Prompt Mega Pack** — a prompt pack that covers:
→ The core framework
→ Ready-to-use templates
→ Step-by-step from zero

It's $17 one-time: https://zenithal43.gumroad.com/l/wyqaan
...
The most common thing I hear: "I'd love to get better at ChatGPT Prompts but I don't have time."
...
If you've been putting it off, ChatGPT Business Prompt Mega Pack gives you the exact 20% to focus on.

$17: https://zenithal43.gumroad.com/l/wyqaan
...
This is the last email I'll send about ChatGPT Business Prompt Mega Pack.
