# Email Marketing Sequence — Client Onboarding Template Kit
# 5 emails over 7 days. Import into Mailchimp / ConvertKit / Beehiiv.

---

## EMAIL 1 — Day 0 (Welcome)
**Subject:** You asked about Freelance Templates — here's where to start

Hi [First Name],

Thanks for joining. I want to give you something useful right away.

The #1 mistake people make with Freelance Templates:
...
Next email comes in 2 days — I'll share the 80/20 of Freelance Templates.
...
## EMAIL 2 — Day 2 (Value)
**Subject:** The 80/20 of Freelance Templates (most people ignore this)

Hi [First Name],

Quick one today.

20% of Freelance Templates techniques produce 80% of results.
...
When I started with Freelance Templates, I spent 6 months consuming content without making real progress.

Why? I was optimizing for learning instead of doing.

The shift that changed everything: I stopped reading about Freelance Templates and started *applying* one thing at a time.

Results came within 2 weeks.

I documented the exact system I built into **Client Onboarding Template Kit** — a business template that covers:
→ The core framework
→ Ready-to-use templates
→ Step-by-step from zero

It's $19 one-time: https://zenithal43.gumroad.com/l/ehqhsf
...
The most common thing I hear: "I'd love to get better at Freelance Templates but I don't have time."
...
If you've been putting it off, Client Onboarding Template Kit gives you the exact 20% to focus on.

$19: https://zenithal43.gumroad.com/l/ehqhsf
...
This is the last email I'll send about Client Onboarding Template Kit.
