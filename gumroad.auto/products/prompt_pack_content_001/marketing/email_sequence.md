# Email Marketing Sequence — 100 ChatGPT & Claude Prompts for Content Creators
# 5 emails over 7 days. Import into Mailchimp / ConvertKit / Beehiiv.

---

## EMAIL 1 — Day 0 (Welcome)
**Subject:** You asked about Prompt Engineering — here's where to start

Hi [First Name],

Thanks for joining. I want to give you something useful right away.

The #1 mistake people make with Prompt Engineering:
...
Next email comes in 2 days — I'll share the 80/20 of Prompt Engineering.
...
## EMAIL 2 — Day 2 (Value)
**Subject:** The 80/20 of Prompt Engineering (most people ignore this)

Hi [First Name],

Quick one today.

20% of Prompt Engineering techniques produce 80% of results.
...
When I started with Prompt Engineering, I spent 6 months consuming content without making real progress.

Why? I was optimizing for learning instead of doing.

The shift that changed everything: I stopped reading about Prompt Engineering and started *applying* one thing at a time.

Results came within 2 weeks.

I documented the exact system I built into **100 ChatGPT & Claude Prompts for Content Creators** — a prompt pack that covers:
→ The core framework
→ Ready-to-use templates
→ Step-by-step from zero

It's $15 one-time: https://zenithal43.gumroad.com/l/uzvqu
...
The most common thing I hear: "I'd love to get better at Prompt Engineering but I don't have time."
...
If you've been putting it off, 100 ChatGPT & Claude Prompts for Content Creators gives you the exact 20% to focus on.

$15: https://zenithal43.gumroad.com/l/uzvqu
...
This is the last email I'll send about 100 ChatGPT & Claude Prompts for Content Creators.
